...
version:    20170213
info:       A script to measure the non-isochromaticity of an energy filter using a spectrum imaging series of the zero-loss peak.
            For more information on non-isochromaticity we refer to: http://dx.doi.org/10.1016/j.ultramic.2006.04.028
"""
